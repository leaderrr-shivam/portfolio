import { Mail, Linkedin, Github, FileText, MapPin, Eye } from 'lucide-react';
      ...
      <div className="container mx-auto px-6 relative" ref={sectionRef}>
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-5xl font-display font-bold mb-5">Let's Connect</h3>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            <a href="mailto:shivam01511@gmail.com" className="card-premium p-6 flex items-center gap-5 group">
            ...
            <a href="https://www.linkedin.com/in/leaderrr-shivam" target="_blank" rel="noopener noreferrer" className="card-premium p-6 flex items-center gap-5 group">
              <div className="icon-container w-16 h-16">
            ...
            <a href="https://github.com/leaderrr-shivam" target="_blank" rel="noopener noreferrer" className="card-premium p-6 flex items-center gap-5 group">
              <div className="icon-container w-16 h-16">
            ...
            <ResumeModal
              trigger={
                <button className="card-premium p-6 flex items-center gap-5 group text-left w-full">
                  <div className="icon-container w-16 h-16">
