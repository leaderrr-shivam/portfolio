...
const certifications = [
  { title: 'Generative AI Fundamentals', issuer: 'Bertelsmann / Udacity', icon: '🎓' },
  { title: 'Google AI Essentials', issuer: 'Coursera', icon: '🔷' },
  { title: 'Career Essentials in Generative AI', issuer: 'Microsoft & LinkedIn', icon: '💼' },
  { title: 'TCS iON Remote Internship (RIO 125)', issuer: 'TCS iON', hours: '125 hrs', icon: '🏢' },
  { title: 'TCS iON Remote Internship (RIO 210)', issuer: 'TCS iON', hours: '210 hrs', icon: '🏢' },
  { title: 'Microsoft–SAP TechSaksham Internship', issuer: 'Edunet Foundation', icon: '🤝' },
];

const softSkills = [
  'Analytical Thinking', 'Technical Communication', 'Self-Discipline',
  'Documentation Excellence', 'Distributed Team Collaboration',
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {certifications.map((cert) => (
              <div key={cert.title} className="card-premium p-6 flex items-start gap-4 group">
          ...
          <div className="card-premium p-8">
            <div className="text-center mb-10">
              ...
              <p className="text-muted-foreground">Core soft skills developed through remote-first work experience</p>
            </div>
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
              {softSkills.map((skill) => (
                <div key={skill} className="flex items-center gap-3 p-4 bg-secondary/50 rounded-xl border border-border/30 hover-lift group">
